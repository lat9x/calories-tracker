    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = { carbRatio ->
                    viewModel.onEvent(
                        event = NutrientGoalEvent.OnCarbPercentageEnter(
            ...
            UnitTextField(
                ...
                onValueChange = { proteinRatio ->
                    viewModel.onEvent(
                        event = NutrientGoalEvent.OnProteinPercentageEnter(
            ...
            UnitTextField(
                ...
                onValueChange = { fatRatio ->
                    viewModel.onEvent(
                        event = NutrientGoalEvent.OnFatPercentageEnter(fatPercentage = fatRatio)
                    )
                },
