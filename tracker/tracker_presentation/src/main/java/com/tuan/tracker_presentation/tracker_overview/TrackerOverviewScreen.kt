...
import com.tuan.tracker_presentation.tracker_overview.components.*

@ExperimentalCoilApi
@Composable
fun TrackerOverviewScreen(
    onNavigateToSearchScreen: (mealName: String, day: Int, month: Int, year: Int) -> Unit,
    ...
    LazyColumn(
        ...
        item {
            ...
            DaySelector(
                date = state.date,
                onPreviousDayClick = {
                    viewModel.onEvent(event = TrackerOverviewEvent.OnPreviousDayClick)
                },
                onNextDayClick = {
                    viewModel.onEvent(event = TrackerOverviewEvent.OnNextDayClick)
                },
                modifier = Modifier
                    .fillMaxWidth()
